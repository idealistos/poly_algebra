...
```math
\begin{matrix}u^2 = 25 \\ u^2 - 2 u z + z^2 = 25 \\ u^2 - 2 u v + v^2 - x^2 - 6x - y^2 = 9 \\ v^2 - x^2 - y^2 + 6x = 9\end{matrix}
```
...
```math
\begin{matrix}16z^2 - z^2 x^2 - z^2 y^2 + 36x^2 = 0 \\ z^2 x^2 = 100x^2\end{matrix}
```
