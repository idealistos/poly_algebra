...
pub struct TwoPointDistanceInvariant {
    pub point1: String,
    pub point2: String,
}

impl TwoPointDistanceInvariant {
    pub fn new(properties: Value) -> Result<Self, SceneError> {
        ...
        Ok(TwoPointDistanceInvariant { point1, point2 })
    }
    ...
    pub fn to_python(&self, _name: &str) -> String {
        ...
        format!("is_constant(d({}, {}))", point1, point2)
    }
...
mod tests {
    ...
    #[test]
    fn test_two_point_distance_invariant() {
        let props = json!({
            "point1": "P1",
            "point2": "P2"
        });
        let inv = TwoPointDistanceInvariant::new(props).unwrap();
        assert_eq!(inv.point1, "P1");
        assert_eq!(inv.point2, "P2");
        assert_eq!(
            inv.get_properties(),
            json!({
                "point1": "P1",
        ...
        assert_eq!(inv.to_python("I1"), "is_constant(d(P1, P2))");
        assert_eq!(inv.get_dependencies(), vec!["P1", "P2"]);
    }
}
